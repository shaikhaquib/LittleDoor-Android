 ...
 */
@HiltViewModel
class DrAppreciationFormVM @Inject constructor(
    private val userDao: UserDao,
    private val mainRepository: MainRepository
) : ViewModel() {
    val formData = MutableLiveData<ArrayList<ActivityAddAppreciation.AppreciationForm>>()

    init {
        formData.value = ArrayList()
    }

    fun addFormItem(item: ActivityAddAppreciation.AppreciationForm) {
