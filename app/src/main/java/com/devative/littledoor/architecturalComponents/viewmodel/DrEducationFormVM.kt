 ...
 */
@HiltViewModel
class DrEducationFormVM @Inject constructor(
    private val userDao: UserDao,
    private val mainRepository: MainRepository
) : ViewModel() {
    val formData = MutableLiveData<ArrayList<ActivityAddEducationForm.EducationFormData>>()

    init {
        formData.value = ArrayList()
    }

    fun addFormItem(item: ActivityAddEducationForm.EducationFormData) {
