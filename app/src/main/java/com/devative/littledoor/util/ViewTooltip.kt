...
class ViewTooltip {
    ...
    fun padding(left: Int, top: Int, right: Int, bottom: Int): ViewTooltip {
        tooltip_view.vPaddingTop = top
        tooltip_view.vPaddingBottom = bottom
        tooltip_view.vPaddingLeft = left
        tooltip_view.vPaddingRight = right
        return this
    }
    ...
    class TooltipView(context: Context?) : FrameLayout(
        context!!
    ) {
        ...
        var vPaddingTop = 20
        var vPaddingBottom = 30
        var vPaddingRight = 30
        var vPaddingLeft = 30
        ...
        fun setPosition(position: Position) {
            ...
            when (position) {
                Position.TOP -> setPadding(
                    ...
                    vPaddingTop,
                    vPaddingRight,
                    vPaddingBottom + arrowHeight
                )

                Position.BOTTOM -> setPadding(
                    vPaddingLeft,
                    vPaddingTop + arrowHeight,
                    vPaddingRight,
                    vPaddingBottom
                )
                ...
                Position.LEFT -> setPadding(
                    vPaddingLeft,
                    vPaddingTop,
                    vPaddingRight + arrowHeight,
                    vPaddingBottom
                )

                Position.RIGHT -> setPadding(
                    vPaddingLeft + arrowHeight,
                    vPaddingTop,
                    vPaddingRight,
                    vPaddingBottom
                )
        ...
        private fun drawBubble(
            ...
            val spacingLeft =
                (if (position == Position.RIGHT) arrowHeight else marginLeft).toFloat()
            val spacingTop = (if (position == Position.BOTTOM) arrowHeight else marginTop).toFloat()
            val spacingRight =
                (if (position == Position.LEFT) arrowHeight else marginRight).toFloat()
            val spacingBottom =
                (if (position == Position.TOP) arrowHeight else marginBottom).toFloat()
    ...
    companion object {
        fun on(view: View): ViewTooltip {
            return ViewTooltip(MyContext(getActivityContext(view.context)), view)
        }
        ...
        fun on(activity: Activity, rootView: View, view: View): ViewTooltip {
            return ViewTooltip(MyContext(getActivityContext(activity)), rootView, view)
        }
